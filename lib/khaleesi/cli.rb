  ...
  class CLI
    ...
    class Generate < CLI
      ...
      def self.doc
        ...
        yield '                 but has not yet been versionadded\'s pages, this goal can be helpful when you frequently modify a page'
        yield '                 and want to see the generated effect such as writing a new blog post.'
        yield ''
