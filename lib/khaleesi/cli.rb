  ...
  class CLI
    ...
    class Generate < CLI
      ...
      def self.doc
        ...
        yield '                 but has not yet been versionadded\'s pages. This goal allow you to preview what the generated page'
        yield '                 will look like locally when you frequently modify a page such as writing a new blog post.'
        yield ''
